...
public:
    ...
    //void process(const float* inData, float* outData, juce::MidiBuffer& midiMessages, const int numSamples, const int numInputChannels, const int sampleRate);
...
private:
    ...
    int sampleRate = 44100;  // Set default
