...
void BaseWaveshaper::prepare(const juce::dsp::ProcessSpec &spec) noexcept
{
...
void BaseWaveshaper::process(const juce::dsp::ProcessContextReplacing<float> &context) noexcept
{
